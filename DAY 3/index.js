...
var a="I am a Student at ABES Engineering College";
console.log(a.includes("am"));
console.log(a.includes("ABESSS"));



let student=["Aman","Abhi","Mani","Ansaei","Aaru"];
console.log(student.shift());
console.log(student);
student.unshift("RAJA","AASHU","ABHUDAY");
console.log(student);
student.pop();
console.log(student);
console.log("PI: ",Math.PI);
console.log(Math.max(10,20,50,90,110,4444,8888,999900));
console.log(Math.min(10,20,50,90,110,4444,8888,999900));
